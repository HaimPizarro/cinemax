...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">cinemax documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ComediaComponent.html" data-type="entity-link" >ComediaComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/DramaComponent.html" data-type="entity-link" >DramaComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/TerrorComponent.html" data-type="entity-link" >TerrorComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/Pelicula-1.html" data-type="entity-link" >Pelicula</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Pelicula-2.html" data-type="entity-link" >Pelicula</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Pelicula-3.html" data-type="entity-link" >Pelicula</a>
                            </li>
                            <li class="link">
